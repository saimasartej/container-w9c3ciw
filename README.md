...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w9c3ciw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w9c3ciw.containers.anotherwebservice.com/
...
```
git clone git@github.com:saimasartej/container-w9c3ciw.git
cd container-w9c3ciw
```
...
```
docker attach container-w9c3ciw
```
